...
public class RealFunctionDraw extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlDraw.setInheritsPopupMenu(true);
        pnlDraw.setName("pnlDraw"); // NOI18N
        ...
        getContentPane().add(pnlDraw, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 70, 300, 300));
    ...
    private void drawAxis(){
        ...
        for(float dx = Coordinate.XMIN; dx < Coordinate.XMAX; dx += 1.0){
         ...
         //(0,0)  (0, 20)  y 
         g.drawLine(Coordinate.toScreenX(0.05f),
        ...
        for(float dy = Coordinate.YMIN; dy < Coordinate.YMAX; dy += 1.0){
            g.drawLine(Coordinate.toScreenX(0),
    ...
    private void drawFunction(){
        ...
        for(int i = 0; i < nPoints - 1; i++){
            g.drawLine(Coordinate.toScreenX(x[i]),
